<!DOCTYPE HTML>
<html>
<head><title>Hai Halimah</title>
<!-- Created By Bagusprimayoga -->
<script>alert ('Hai Halimah')
alert ('Selamat Pagi Cantik')</script>
...
tb5_messages[0] = "Hai Mb Santri";
tb5_messages[1] = "Aku Mau Kamu Tau";
tb5_messages[2] = "Aku Sayang Sama Kamu";
tb5_messages[3] = "Aku Rindu dengan Senyumu:)";
tb5_messages[4] = "Aku ga bisa jauh dari kamu";
tb5_messages[5] = "Aku berharap kamu menerimanya";
tb5_messages[6] = "I Miss You Mb Halim:)!!!";
...
<body BGCOLOR="black">
<center><center>
<br><font size="6"><font color="red" face="courier new">by:Bagusprimayoga</font>
<br><br><!-- Created By L3M4R1 -->
<font size="5"><font color="white" face="courier new">Hai Cantik apakah aku berkenan untuk mengharapkan KAMU</font>
<br><font size="5"><font color="white" face="courier new">Selama ini ku hanya dapat diam dan berdoa kepada Allah agar semua Do'a-Do'aku dikabulkan</font>
<br><font size="5"><font color="white" face="courier new">Namun kali ini aku merasakan dahsyatnya perasaan yang tidak bisa diungkapkan</font>
<br><font size="5"><font color="white" face="courier new">Siap menunggu dan ditunguu?!?</font>
<br><a href="https://api.whatsapp.com/send?phone=085378712757&text=Ya%20aku%20Mau%20Terima"><input type="button" value="Yes I do" onclick="alert('Thanks yah udah mau trima aku apa ada nya');" style="font size="5"></a><><><><a href="https://api.whatsapp.com/send?phone=6283198529028&text=maaf%20aku%20nggabisa%20Terima"><input type="button" value=" Im sorry" onclick="alert('Baik lah kalau itu mau mu ^_^');" style="font size="5"></a>
